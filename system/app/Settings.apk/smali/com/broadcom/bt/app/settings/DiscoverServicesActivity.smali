...
.method private processRemoteDiRecord(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    .line 286
    iget v3, p0, Lcom/broadcom/bt/app/settings/DiscoverServicesActivity;->mRecNum:I

    if-ne v3, v5, :cond_0

    .line 287
    const-string v3, "android.bluetooth.adapter.extra.DI_SPEC_ID"
    ...
    invoke-static {p1, v0, p2, v3}, Lcom/broadcom/bt/app/settings/BluetoothDid;->getDidRecord(Landroid/content/Context;Landroid/preference/Preference;Landroid/os/Bundle;I)V

    .line 301
    iget-object v3, p0, Lcom/broadcom/bt/app/settings/DiscoverServicesActivity;->mDidList:Lcom/android/settings/ProgressCategory;

    invoke-virtual {v3, v0}, Lcom/android/settings/ProgressCategory;->addPreference(Landroid/preference/Preference;)Z
    ...
    iput v3, p0, Lcom/broadcom/bt/app/settings/DiscoverServicesActivity;->mRecNum:I

    iget v4, p0, Lcom/broadcom/bt/app/settings/DiscoverServicesActivity;->mTotalRecNum:I
