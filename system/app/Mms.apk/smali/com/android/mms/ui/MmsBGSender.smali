...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    const-string v2, "Bacvkground  Sending for quick send"

    invoke-static {v3, v2}, Lcom/android/mms/Log;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "Sending MMS in background for Quick Send."
    ...
    const-string v2, "Starting Activity for Quick Send."
...
.method public sendQuickmessage(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .prologue
    const-string v12, "mms_image"

    const-string v11, "mms_audio_uri"

    const-string v10, "mms_audio"
    ...
    const-string v6, "sendQuickmessage execute method invoked"

    invoke-static {v8, v6}, Lcom/android/mms/Log;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .end local v3           #mImageUri:Landroid/net/Uri;
    check-cast v3, Landroid/net/Uri;

    .line 714
    .restart local v3       #mImageUri:Landroid/net/Uri;
    const-string v6, "MMSBGSender"
    ...
    const-string v7, "Setting state for recipientActivity :"
    ...
    const-string v7, "Setting state for Audio Content :"
    ...
    invoke-virtual {v5, v11, v1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    ...
    const-string v6, "sendQuickmessage execute method completed"
